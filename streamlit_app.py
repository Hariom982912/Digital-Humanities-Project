...
data = [
    ...
    # ---- INDIAN ECOSYSTEM ----
    {
        ...
        "imgs": [
          ...
          f'<iframe src="https://mirrikh.com/tata-semi-plant-in-dholera/" width="870" height="390" style="border:none;"></iframe>',
          f'<iframe src="https://www.outlookbusiness.com/corporate/tata/" width="870" height="390" style="border:none;"></iframe>',
          f'<iframe src="https://www.facebook.com/dholeraawareness/" width="870" height="390" style="border:none;"></iframe>'
        ],
